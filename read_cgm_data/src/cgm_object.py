...
class CGM(object):
    ...
    def plot_agp_report(self):
        ...
        #ax.bar(16,height=330-310,width=42,color='black',bottom=310)
        ...
        mid=[];minutes = []
        ### Title ###################
        # ax.annotate("TIME IN RANGES",xy=(-4,315),color='white',
        #             weight="bold",fontsize=bg_font+5)
...
class st_CGM(object):
    def __init__(self,names,
        ...
        self.df = df
        cols = ['mean','std','num_obs',
                'cv','mag','j_index',
                'gvp','m_value_paper',
                'li','modd_paper','conga_paper',
                'm_value_paper','auc_100_all+','gmi','iqr',
                'auc_100_wake+','auc_100_sleep+','auc_all',
                'auc_wake','auc_sleep',
                'conga_easy','modd_easy','m_value_easy']
