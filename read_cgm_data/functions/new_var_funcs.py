...
from ..utils.utility_functions import timer
...
"""
Code kept in because it is unique and may need to use later.
# def total_days(x,**kwargs):
#     th = x.groupby('day').apply(total_hours,**kwargs,include_groups=False)
#     if (0 in th.index) and (1 in th.index):
#         idx = [0,1]
#         th[idx] = th[idx]/np.array([6,18])
#     elif (0 in th.index):
#         idx = [0]
#         th[idx] = th[idx]/6
#     elif (1 in th.index):
