...
pages_master = {0:[":house: Home","app_launch.py"],
              ...
              4:[":man-man-boy-boy: Cohort Data","pages/4_compare_data.py"],
              5:[":floppy_disk: Export Data","pages/5_export_data.py"],
              #6:[":date: Transform Data","pages/6_transform_data.py"],
}
...
if 'calc_units' not in st.session_state:
    st.session_state['calc_units']='mg'
...
if select == options[0]:
    ...
    st.markdown(body)
    img_link = "https://images.squarespace-cdn.com/content/v1/5be5c21e75f9ee21b5817cc2/"
    img_link+="34299c29-857b-4989-93b8-4e08430e6045/process.png?format=1000w"
    st.image(img_link,
             width = 700,
